...
from backend.auth.auth import gen_token_by_login, get_token_by_recovery
...
templates = Jinja2Templates(directory=settings.static_files_path)
...
async def post_change_password(
    ...
    return await crud.change_password(user_in, session)
